...
/* Timer period configurations based on clock ticks */
...
/* Feature flags for controlling inbuilt LEDs */
#define ENABLE_LED1 
#define ENABLE_LED2 
...
/* Default parameters passed during peripheral initializations */
#ifdef ENABLE_PWM_LED1
#define LED1_DEFAULT_DUTY_CYCLE 100    // Default 50 % (overridden dynamically by FSM)
#define LED1_DEFAULT_PERIOD     SET_PERIOD_1_SECS
#endif

#ifdef ENABLE_PWM_LED2
#define LED2_DEFAULT_PERIOD     SET_PERIOD_1_SECS
#define LED2_DEFAULT_DUTY_CYCLE 50     // Default 50 % (overridden dynamically by FSM)
#endif

/**
 * @brief Entry point function for the main runtime application loops.
 * @return fsp_err_t FSP_SUCCESS on typical execution initialization.
 */
